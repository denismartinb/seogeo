...
Para cada mejora devuelve un objeto con estos campos exactos:
{
  ...
  "current_issue": "describe el ESTADO ACTUAL: si el elemento ya existe indica su valor actual entre comillas, si está oculto menciónalo (ej: 'El H1 actual «Ofertas Fibra» está visualmente oculto con clase visuallyhidden'), si no existe dilo claramente",
  "suggestion": "acción específica: 'Modifica el H1 existente a...' o 'Añade un H1 nuevo con...' — nunca digas 'añade' si el elemento ya existe",
